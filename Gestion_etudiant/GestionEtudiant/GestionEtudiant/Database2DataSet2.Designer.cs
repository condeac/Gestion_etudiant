...
namespace GestionEtudiant {
    ...
    public partial class Database2DataSet2 : global::System.Data.DataSet {
        ...
        public partial class StudDataTable : global::System.Data.TypedTableBase<StudRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudRow AddStudRow(string name, int age) {
        ...
        public partial class StudRow : global::System.Data.DataRow {
            ...
            public string name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'name\' dans la table \'Stud\' est DBNull.", e);
                    }
                }
                set {
            ...
            public int age {
                get {
                    try {
                        return ((int)(this[this.tableStud.ageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'age\' dans la table \'Stud\' est DBNull.", e);
                    }
                }
                set {
                    this[this.tableStud.ageColumn] = value;
                }
            }
            ...
            public bool IsageNull() {
                return this.IsNull(this.tableStud.ageColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetageNull() {
                this[this.tableStud.ageColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace GestionEtudiant.Database2DataSet2TableAdapters {
    ...
    public partial class StudTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Stud] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Stud] ([name], [age]) VALUES (@name, @age);\r\nSELECT Id, name, " +
                "age FROM Stud WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Stud] SET [name] = @name, [age] = @age WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)));
SELECT Id, name, age FROM Stud WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GestionEtudiant.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, age FROM dbo.Stud";
        ...
        public virtual int Fill(Database2DataSet2.StudDataTable dataTable) {
        ...
        public virtual Database2DataSet2.StudDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database2DataSet2.StudDataTable dataTable = new Database2DataSet2.StudDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database2DataSet2.StudDataTable dataTable) {
